...
@rem Use JDK 17+ for Android/KMP builds. gradle/jdk.home overrides; else prefer Android Studio JBR on Windows.
if exist "%APP_HOME%\gradle\jdk.home" (
  set /p JAVA_HOME=<"%APP_HOME%\gradle\jdk.home"
